...
namespace DAL.Xunit
{
    public class Card_LogsUnitTest
    {
        ...
        public void CreateCardLogsAndUpdateTest1()
        {
            ...
            Assert.True(cardLogsDAL.UpdateCardLogsByLicensePlateAndCardID(cardLogs, "33G1-3333", 10011, "2019-06-05 00:00:00"));
        }
        [Fact]
        public void CreateCardLogsAndUpdateTest2()
        {
            Card_LogsDAL cardLogsDAL = new Card_LogsDAL();
            Card_Logs cardLogs = new Card_Logs(10015, "security_01", "88A1-8888", new DateTime(2019,06,05), null, null, 10000);
            Assert.True(cardLogsDAL.CreateCardLogs(cardLogs));
            cardLogs = new Card_Logs(10015, null, null, null, DateTime.Now,10000,1);
            cardLogsDAL = new Card_LogsDAL();
            Assert.True(cardLogsDAL.UpdateCardLogsByLicensePlateAndCardID(cardLogs, "88A1-8888", 10015, "2019-06-05 00:00:00"));
        }
        [Fact]
