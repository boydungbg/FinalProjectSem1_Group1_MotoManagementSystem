...
namespace DAL.Xunit
{
    public class Card_LogsUnitTest
    {
        ...
        public void CreateCardLogsAndUpdateTest1()
        {
            ...
            Card_Logs cardLogs = new Card_Logs(10011, "security_01", "75G1-2222", new DateTime(2019, 05, 20), null, null, null);
            Assert.True(cardLogsDAL.CreateCardLogs(cardLogs));
            cardLogs = new Card_Logs(10011, null, null, null, DateTime.Now, "08:00", 0);
