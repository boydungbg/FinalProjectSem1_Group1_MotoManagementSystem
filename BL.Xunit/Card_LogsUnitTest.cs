...
namespace BL.Xunit
{
    public class Card_LogsUnitTest
    {
        ...
        public void CreateCardLogsTest1()
        {
            ...
            Card_Logs card_Logs = new Card_Logs("CM06", "security_01", "75-G1-2222", new DateTime(2019, 05, 20), null, null, null);
            ...
            Assert.True(cardLogsBL.UpdateCardLogsByLicensePlateAndCardID(card_Logs, "CM06", "75-G1-2222", "2019-05-20 00:00:00"));
            cardLogsBL = new Card_LogsBL();
        ...
        public void CreateCardLogsTest2()
        {
            ...
            cardLogsBL = new Card_LogsBL();
            card_Logs = new Card_Logs(null, null, null, null, DateTime.Now, "07:00", 0);
            Assert.False(cardLogsBL.UpdateCardLogsByLicensePlateAndCardID(null, "CM06", "75-G1-2222", "2019-05-20 00:00:00"));
            cardLogsBL = new Card_LogsBL();
        ...
        {
            Card_LogsBL cardLogsBL = new Card_LogsBL();
            Card_Logs card_Logs = cardLogsBL.GetCardLogsByLisencePlateAndCardID("11-X9-9912", "CM01");
